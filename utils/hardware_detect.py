...
class HardwareDetector:
    ...
    def _detect_capabilities(self) -> Dict:
        ...
        from tpu_mlir_runner import UniversalInferenceRunner
        ...
        # Try to detect TPU/NPU capabilities
        try:
            runner = UniversalInferenceRunner()
            if isinstance(runner.accelerator, RKNNAccelerator):
            ...
            elif isinstance(runner.accelerator, CVITEKAccelerator):
                caps["accelerators"].append({
                    "type": "TPU",
                    "name": "CVITEK",
                ...
                caps["quantization"].extend(["int8", "bf16"])
        except:
            pass
